...
public class SpawnGoldScheduler extends BukkitRunnable{
    Neptune plugin;
    World world;
    int count=0;

    public SpawnGoldScheduler(Neptune plugin,World world) {
        this.plugin = plugin;
        this.world = world;
    }
    ...
    @Override
    public void run () {
        Location location = new Location(this.world, -822, 201, -356);
        this.world.dropItemNaturally(location, new ItemStack(Material.IRON_INGOT));

        Location location2 = new Location(this.world, -822, 201, -260);
        this.world.dropItemNaturally(location2, new ItemStack(Material.IRON_INGOT));

        Location location3 = new Location(this.world, -870, 201, -308);
        this.world.dropItemNaturally(location3, new ItemStack(Material.IRON_INGOT));

        Location location4 = new Location(this.world, -774,  201, -308);
